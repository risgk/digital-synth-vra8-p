# Digital Synth VRA8-Px 2.x.0

- 2017-07-xx ISGK Instruments
...
## MIDI Implementation Chart
      ...
      [Paraphonic Synthesizer]                                        Date: 2017-07-xx       
      Model: Digital Synth VRA8-Px    MIDI Implementation Chart       Version: 2.x.0         
    +-------------------------------+---------------+---------------+-----------------------+
