...
OSC_CONTROL_INTERVAL_BITS   = 4
OSC_CONTROL_INTERVAL        = 0x01 << OSC_CONTROL_INTERVAL_BITS
OSC_PHASE_RESOLUTION_BITS   = 24
OSC_TUNE_TABLE_STEPS_BITS   = 7
OSC_TUNE_DENOMINATOR_BITS   = 16
...
OSC_WAVEFORM_SAW     = 0
OSC_WAVEFORM_ORGAN_4 = 48
OSC_WAVEFORM_ORGAN_9 = 64
OSC_WAVEFORM_ORGAN_3 = 80
OSC_WAVEFORM_SQ      = 127
