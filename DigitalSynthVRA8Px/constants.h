...
const uint8_t   OSC_CONTROL_INTERVAL_BITS   = 4;
const uint8_t   OSC_CONTROL_INTERVAL        = 0x01 << OSC_CONTROL_INTERVAL_BITS;
const uint8_t   OSC_PHASE_RESOLUTION_BITS   = 24;
const uint8_t   OSC_TUNE_TABLE_STEPS_BITS   = 7;
const uint8_t   OSC_TUNE_DENOMINATOR_BITS   = 16;
...
const uint8_t   OSC_WAVEFORM_ORGAN_4 = 48;
const uint8_t   OSC_WAVEFORM_ORGAN_9 = 64;
const uint8_t   OSC_WAVEFORM_ORGAN_3 = 80;
